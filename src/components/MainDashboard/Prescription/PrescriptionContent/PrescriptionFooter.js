...
const PrescriptionFooter = () => {
  ...
  return (
    <div className={style["div-userInfo"]}>
      <div>
        <p>
          Patient: {currentPrescription.prescribedTo.firstName}{" "}
          {currentPrescription.prescribedTo.secondName}{" "}
          {currentPrescription.prescribedTo.lastName}
        </p>
        <p>Age: {currentPrescription.prescribedTo.age}</p>
        <p>Specifics: {currentPrescription.prescribedTo.specifics}</p>
        <p>Gender: {currentPrescription.prescribedTo.gender}</p>
      </div>
      <div className={style["center-div"]}>
        {user.role === "pharmacist" && (
          <div className={style["center-div"]}>
            <p>Fulfilled prescription?</p>
