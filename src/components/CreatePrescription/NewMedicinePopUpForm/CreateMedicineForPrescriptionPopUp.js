    ...
    <div className={style["form-container"]}>
      <Form onSubmit={addMedicineHandler}>
        ...
        <InputGroup className="mb-3">
          <Form.Control
            type="text"
            placeholder={!error.dosage ? "Dosage" : "This field is required"}
            name="dosage"
          ...
          >
            <option value="">
              {!error.dosageType ? "Select unit" : "This field is required"}
            </option>
        ...
        <InputGroup className="mb-3">
          <Form.Control
            type="text"
            placeholder={
              !error.admission ? "Single dose" : "This field is required"
            }
